...
export function SubHDCandidateDetails({ candidate, applied = false, showTitle = true }: { candidate: SubtitleSearchCandidate; applied?: boolean; showTitle?: boolean }) {
  ...
  return (
    <div className="mt-3 border-t border-sand-100 pt-3">
      <div className={`flex flex-wrap items-start gap-2 ${showTitle ? 'justify-between' : 'justify-end'}`}>
        {showTitle && (candidate.url ? (
